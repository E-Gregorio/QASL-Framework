 ...
 *
 * Uso:
 *   node scripts/run-k6.mjs [capture-file] [--vus=10] [--duration=30s]
 *
 * Ejemplos:
 *   node scripts/run-k6.mjs                           # Usa última captura
 *   node scripts/run-k6.mjs ts-001-apis.json          # Captura específica
 *   node scripts/run-k6.mjs --vus=20 --duration=60s   # Config personalizada
 *
 * Reportes:
