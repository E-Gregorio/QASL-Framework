-- ============================================================
-- SIGMA - Importar CSV a Base de Datos
-- Compatible con SQL Server 2019+
-- ============================================================
-- IMPORTANTE: Este script usa el DDL real de SIGMA DDL.sql
-- ============================================================
...
PRINT '========================================';
PRINT 'SIGMA - Importar CSV';
PRINT 'Inicio: ' + CONVERT(VARCHAR, GETDATE(), 120);
PRINT '========================================';
PRINT '';

-- ============================================================
-- PASO 2: CREAR ESTRUCTURA (DDL REAL - SIGMA DDL.sql)
-- ============================================================
...
-- Perfil y Usuario del sistema (necesarios para FK)
SET IDENTITY_INSERT perfil ON;
INSERT INTO perfil (id, nombre, descripcion, activo, modificado_por, creado_por)
VALUES (1, 'Sistema', 'Usuario del sistema para cargas automaticas', 'S', 1, 1);
...
-- Tributos (LO = Local, CM = Convenio Multilateral)
INSERT INTO tributo (codigo, nombre, jurisdiccion, activo, modificado_por, creado_por)
VALUES
    (1, 'ISIB Local', 'Local', 'S', 1, 1),
    (2, 'ISIB Convenio Multilateral', 'Convenio Multilateral', 'S', 1, 1);
...
-- CONFIGURACION: Modificar esta ruta segun tu ambiente
DECLARE @RutaCSV NVARCHAR(500) = 'C:\Users\Epidater\Desktop\Proyectos\sql-sigma-pruebas\Dummy de Archivo a Importar - Ejemplos Archivo a Importar.csv';

-- Tabla temporal para cargar CSV
...
-- Importar CSV (FORMAT=CSV maneja campos entrecomillados)
...
-- Insertar contribuyentes unicos
...
-- Insertar inconsistencias con conversion de formato argentino
